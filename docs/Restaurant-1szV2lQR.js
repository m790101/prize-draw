import { _ as _export_sfc, c as createElementBlock, a as createBaseVNode, b as createCommentVNode, F as Fragment, r as renderList, t as toDisplayString, o as openBlock } from './index-qruG1cd1.js';
...
const _hoisted_15 = { class: "flex justify-between items-center text-sm text-gray-600 mb-4" };
const _hoisted_16 = ["onClick"];
const _hoisted_17 = {
  key: 3,
  class: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4"
};
const _hoisted_18 = { class: "bg-white rounded-xl p-8 max-w-md w-full transform animate-pulse" };
const _hoisted_19 = { class: "text-center" };
const _hoisted_20 = { class: "text-6xl mb-4 block" };
const _hoisted_21 = { class: "text-lg text-gray-600 mb-4" };
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList($data.restaurants, (restaurant, index) => {
                return (openBlock(), createElementBlock("div", {
                  ...
                  createBaseVNode("div", _hoisted_8, [
                    ...
                    createBaseVNode("div", _hoisted_15, "地址：" + toDisplayString(restaurant.address), 1),
                    createBaseVNode("button", {
                    ...
                    }, " 點我進 google map 看看 🎯 ", 8, _hoisted_16)
                  ])
                ]))
              }), 128))
            ])
        ...
        ? (openBlock(), createElementBlock("div", _hoisted_17, [
            createBaseVNode("div", _hoisted_18, [
              createBaseVNode("div", _hoisted_19, [
                createBaseVNode("span", _hoisted_20, toDisplayString($data.selectedRestaurant.emoji), 1),
                _cache[5] || (_cache[5] = createBaseVNode("h3", { class: "text-2xl font-bold text-gray-800 mb-2" }, "Great Choice!", -1)),
                createBaseVNode("p", _hoisted_21, " You selected " + toDisplayString($data.selectedRestaurant.name) + "! ", 1),
                createBaseVNode("button", {
...
const Restaurant = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render],['__scopeId',"data-v-c430dc54"]]);
