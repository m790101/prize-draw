...
const _hoisted_3 = { class: "flex gap-4 mb-4" };
...
const _hoisted_9 = { class: "bg-white rounded-lg shadow-lg p-6" };
const _hoisted_10 = { class: "text-center mb-6" };
...
const _hoisted_13 = { class: "bg-gradient-to-r from-yellow-100 to-orange-100 border-2 border-yellow-300 rounded-lg p-6 text-center" };
const _hoisted_14 = {
  id: "winnerDisplay",
      ...
      createBaseVNode("div", _hoisted_10, [
        (!sessionReady.value)
          ? (openBlock(), createElementBlock("button", {
            ...
            }, " press to start session ", 8, _hoisted_11))
          : createCommentVNode("", true),
        (sessionReady.value)
          ? (openBlock(), createElementBlock("button", {
              key: 1,
      ...
      (winner.value)
        ? (openBlock(), createElementBlock("div", _hoisted_12, [
            createBaseVNode("div", _hoisted_13, [
              ...
              createBaseVNode("div", _hoisted_14, toDisplayString(winner.value), 1),
